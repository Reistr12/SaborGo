...
// const LimparPedidos = document.getElementById('limpar-pedidos')
// let ConfirmLimpar = false;

// LimparPedidos.addEventListener('click', () => {
...
// //minha forma de tentar resolver o erro
// if(ConfirmLimpar){
//     confirmar();
//     ConfirmLimpar = false;
//     return;
...
if (LimparPedidos) {
  LimparPedidos.addEventListener('click', () => {
    if (confirm('Tem certeza que deseja apagar todos os pedidos?')) {
      localStorage.removeItem('pedidos'); // Remove todos os pedidos
      localStorage.removeItem('ultimoPedidoEnviado'); // Remove o status do último pedido
      alert('Todos os pedidos e status foram apagados!');
